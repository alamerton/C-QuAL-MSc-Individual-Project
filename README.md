...
This is the repo for my MSc individual project: **QCLM-Bench: _a Question answering Clinical Large language Model Benchmarking dataset_**. This repo contains the code for generating the dataset.
