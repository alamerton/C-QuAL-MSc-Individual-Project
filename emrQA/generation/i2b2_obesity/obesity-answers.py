            ...
            if answer_type == "problems":
                ...
                for temp in [Y_class, N_class, U_class]:
                    ...
                    for problem in temp:
                        ...
                        zip_object = zip(question_lits,question_template)
                        list_zip = list(zip_object)
                        list_zip.append(orginal_lform)
                        answer = {"answers": ans_list, "id": list_zip, "question": question_lits}

                        out["qas"].append(answer)
            else:
                print("Answer type printout: ", answer_type)

        obesity_out["paragraphs"].append(out)

    # obesity_out = list(obesity_data)
